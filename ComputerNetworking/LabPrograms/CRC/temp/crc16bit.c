#include <stdio.h>
#include <string.h>
char *bindiv(char *,char *);
char *binsub(char *,char *);
int f=0,ll=0; 
main()
{
...
char *bindiv(char *s,char *d)
{
	int i,j,k=0,x=17,h,p=0,c;
	char q[25]="",b[30],*w;
